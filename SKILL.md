---
name: top-claude-code-skills
description: Référence complète des meilleurs skills et repos GitHub pour Claude Code, classés par catégorie. Utilisez ce skill quand l'utilisateur cherche un skill Claude Code spécifique ou une liste organisée par domaine.
---

# 🏆 Top Claude Code Skills — Référence Complète
...
| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`JuliusBrussee/caveman`](https://github.com/JuliusBrussee/caveman) | 78k | Skill caveman : -65% tokens |
| [`colbymchenry/codegraph`](https://github.com/colbymchenry/codegraph) | 56k | Knowledge graph local |
| [`drona23/claude-token-efficient`](https://github.com/drona23/claude-token-efficient) | 5.7k | CLAUDE.md drop-in : -63% tokens |
| [`shanraisshan/claude-code-best-practice`](https://github.com/shanraisshan/claude-code-best-practice) | 62k | Best practices Claude Code |
| [`garrytan/gstack`](https://github.com/garrytan/gstack) | 118k | 23 outils opinionnés (CEO, Designer, QA…) |
| [`yamadashy/repomix`](https://github.com/yamadashy/repomix) | 27k | Packe ton repo en un fichier AI-friendly |
| [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) | 46k | Notebooks/recettes officielles Anthropic |

## 🎨 Design & Frontend

| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`pbakaus/impeccable`](https://github.com/pbakaus/impeccable) | 42k | Design language system — 18 commandes |
| [`emilkowalski/skills`](https://github.com/emilkowalski/skills) | 3.7k | Skills Design Engineers |
| [`Jeffallan/claude-skills`](https://github.com/Jeffallan/claude-skills) | 10k | 66 skills full-stack |
| [`senlindesign/taste-skill`](https://github.com/senlindesign/taste-skill) | 196 | Reverse-engineer design de sites |
| [`wilwaldon/Claude-Code-Frontend-Design-Toolkit`](https://github.com/wilwaldon/Claude-Code-Frontend-Design-Toolkit) | 396 | Toolkit frontend complet |
| [`tenfoldmarc/website-builder-setup`](https://github.com/tenfoldmarc/website-builder-setup) | 225 | Setup UI/UX Pro Max + Framer Motion + 21st.dev |
| [`ali-abassi/framer-motion-skill`](https://github.com/ali-abassi/framer-motion-skill) | 8 | Skill Framer Motion pour animations UI |
| [`mikeoptimax/claude-frontend-skills-pack`](https://github.com/mikeoptimax/claude-frontend-skills-pack) | 13 | Pack frontend : 21st.dev 1400+ composants + Framer Motion |
| [**21st.dev**](https://21st.dev) | — | Marketplace de composants React (similaire Aceternity) |
| [**UI/UX Pro Max**](https://uiuxpromax.com) | — | Skill design UI/UX pour Claude Code |
...
| [`guzus/go-viral`](https://github.com/guzus/go-viral) | 12 | Skill optimisation posts X/Twitter |
| [`Laura-Beaulieu/growthloops-claude-skills`](https://github.com/Laura-Beaulieu/growthloops-claude-skills) | 2 | Skills growth B2B SaaS : competitive ads, audits contenu |
| [`stevenflanagan1/social-ai-team`](https://github.com/stevenflanagan1/social-ai-team) | 147 | Skills social media — équipe IA complète pour SMB : brand, calendrier, captions, créatif |
| [`bradautomates/head-of-content`](https://github.com/bradautomates/head-of-content) | 129 | Skills recherche contenu social media et marketing |

## 🛡️ Cybersécurité

| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`mukul975/Anthropic-Cybersecurity-Skills`](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) | 23k | 817 skills cybersécurité (6 frameworks) |
...
| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`MagicCube/agentara`](https://github.com/MagicCube/agentara) | 475 | Assistant 24/7 multi-canal |
| [`letta-ai/claude-subconscious`](https://github.com/letta-ai/claude-subconscious) | 2.8k | Subconscient Claude |
| [`eugeniughelbur/obsidian-second-brain`](https://github.com/eugeniughelbur/obsidian-second-brain) | 2.8k | Second brain Obsidian — vault AI-first multi-CLI |
| [`coleam00/second-brain-skills`](https://github.com/coleam00/second-brain-skills) | 785 | Collection de skills pour transformer Claude Code en Second Brain |
| [`coleam00/second-brain-starter`](https://github.com/coleam00/second-brain-starter) | 646 | Génère un PRD personnalisé pour un assistant IA proactif |
| [`huytieu/COG-second-brain`](https://github.com/huytieu/COG-second-brain) | 569 | Second brain auto-évolutif : 17 skills, 6 agents, CRM — inspiré de gstack |
| [`charlie947/ai-second-brain`](https://github.com/charlie947/ai-second-brain) | 83 | Second brain depuis historique ChatGPT/Claude — style Karpathy |
| [`Yeachan-Heo/oh-my-claudecode`](https://github.com/Yeachan-Heo/oh-my-claudecode) | 37k | Orchestrateur multi-agent |
| [`golutra/golutra`](https://github.com/golutra/golutra) | 3.7k | Orchestrateur multi-agent |

## 📊 Monitoring & Dashboards

| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`jarrodwatts/claude-hud`](https://github.com/jarrodwatts/claude-hud) | 26k | HUD temps réel |
| [`AgentSeal/codeburn`](https://github.com/AgentSeal/codeburn) | 8.3k | Tracking tokens |
| [`cordwainersmith/Claudoscope`](https://github.com/cordwainersmith/Claudoscope) | 200 | Dashboard macOS |
| [`es617/claude-replay`](https://github.com/es617/claude-replay) | 739 | Replay sessions HTML |
| [`tw93/claude-health`](https://github.com/tw93/claude-health) | 527 | Audit santé config |

## 🧠 Multi-Agent & LLM Council

| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`aiwithremy/claude-skills-llm-council`](https://github.com/aiwithremy/claude-skills-llm-council) | 860 | 5 AI advisors + peer review |
| [`hex/claude-council`](https://github.com/hex/claude-council) | 404 | Plugin multi-agent council |
| [`gcpdev/llm-council-skill`](https://github.com/gcpdev/llm-council-skill) | 291 | Brainstorming multi-LLM |

## 🏢 CRM & Business

| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`twentyhq/twenty`](https://github.com/twentyhq/twenty) | 52k | CRM open source (alternative Salesforce) |
| [`zubair-trabzada/ai-legal-claude`](https://github.com/zubair-trabzada/ai-legal-claude) | 1.5k | Assistant légal AI : review contrats, analyse risques, NDA, compliance, stratégie négociation |
| [`JoelLewis/finance_skills`](https://github.com/JoelLewis/finance_skills) | 144 | 81 skills services financiers : gestion d'investissement, compliance, advisory, trading |

## 🎬 Création Vidéo / Media

| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`heygen-com/hyperframes`](https://github.com/heygen-com/hyperframes) | 32k | Write HTML. Render video. Built for agents. Framework animation/rendering vidéo |
| [`beshuaxian/higgsfield-seedance2-jineng`](https://github.com/beshuaxian/higgsfield-seedance2-jineng) | 638 | 15 skills génération vidéo |
| [`OpenCut-app/OpenCut`](https://github.com/OpenCut-app/OpenCut) | 60k | Alternative open source à CapCut |

## 🏗️ Workspaces & Config

| Repo | ⭐ | Description |
|------|:--:|-------------|
| [`pewdiepie-archdaemon/odysseus`](https://github.com/pewdiepie-archdaemon/odysseus) | 79k | Workspace IA auto-hébergé |
| [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) | 860 | Plugins Claude Code |
| [`hesreallyhim/awesome-claude-code`](https://github.com/hesreallyhim/awesome-claude-code) | 48k | Curated skills Claude |
...
| Site | Description |
|------|-------------|
| [Aceternity UI](https://aceternity.com) | Composants React animés |
| [Referral Styles](https://referral.design) | Style pour IA |
| [Mobin](https://mobin.app) | Copier écrans d'apps |
| [Godly](https://godly.ai) | Inspiration design |
| [21st.dev](https://21st.dev) | Marketplace composants React |
| [UI/UX Pro Max](https://uiuxpromax.com) | Skill design UI/UX |
| [10x](https://10x.app) | Générateur app iOS native |
